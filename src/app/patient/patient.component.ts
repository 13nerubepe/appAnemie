...
export class PatientComponent {
  ...
  private anemieService = inject(AnemieService);
  ...
  setSexe(v: number) {
    this.patient.sexe_enfant = v;
  }


  setDiarrhee(v: number) {
    this.patient.diarrhee = v;
  }


  setFievre(v: number) {
    this.patient.fievre = v;
  }


  setDeparasitage(v: number) {
    this.patient.deparasitage = v;
  }


  setMilieu(v: number) {
    this.patient.milieu_residence = v;
  }
  ...
  onSubmit() {
    ...
    const payload = {
      ...
      nom_praticien:
        `${this.patient.prenom} ${this.patient.nom}`.trim()
        || undefined,


      structure_sante:
        this.patient.structure_sante || undefined,


      notes:
        this.patient.notes || undefined,
    ...
    this.anemieService.predict(payload)
      .subscribe({
